...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void DestroyMesh()
    {
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            parts[i].GameObject.GetComponent<MeshDestroy>().StartCoroutine(DestroyAfter(parts[i].GameObject, 10f));
        }
        Destroy(gameObject);
    }

    public IEnumerator DestroyAfter(GameObject go, float seconds)
    {
